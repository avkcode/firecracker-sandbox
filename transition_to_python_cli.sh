...
echo -e "  sudo fc --help"
echo -e "  sudo fc setup"
echo -e "  sudo fc teardown"
echo -e "  sudo fc start --config-file my-config.json"
echo -e "  sudo fc --tap-device tap1 --tap-ip 192.168.2.1 setup"
echo -e "  sudo fc generate-guest-config"
echo -e "  sudo fc show-config"
echo ""
